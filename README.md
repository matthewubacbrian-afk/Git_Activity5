...
- The tree above documents files and branches involved in this repository simulation.
- Branch entries represent workflow scenarios and team actions.
- `.env` is intentionally shown as part of the scenario and should remain ignored in the actual repository.
